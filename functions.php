...
function wdCabureweb_widgets_init() {
  ...
  register_sidebar( array(
	// No cambiar el nombre del widget, es usado como paramentro en obtenerElementoWidget()
    'name'          => 'Siatrasag_Galeria',
    'id'            => 'id-galeria-siatrasag',
    'description'   => 'Cargar galeria con titulo.',
    'before_widget' => '<div class="hola">',
    'after_widget'  => '</div>',
    'before_title'  => '<h1 class="mundo">',
    'after_title'   => '</h1>',
  ));
...
function obtenerElementoWidget( $sidebar_name ) {
